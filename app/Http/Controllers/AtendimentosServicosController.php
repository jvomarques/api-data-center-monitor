...
{
    public function showAtendimentosId(AtendimentosServicosRepositoryInterface $repository, $atendimentos_id)
    {
        return $repository->showAtendimentosId($atendimentos_id);
    }
